...
QtObject {
    ...
    property var _conn: Connections {
        ...
        function onEventReceived(event, data) {
            if (event === "ryogami.wall.analysis.progress") {
