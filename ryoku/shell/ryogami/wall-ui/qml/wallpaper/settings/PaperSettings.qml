...
Column {
    ...
    SettingsCard {
        ...
        SettingsRow {
            ...
            description: "I prefer Ryogami-paper because I made it, but use Awww if that's your thing :)"
            Row {
                spacing: 4
                Repeater {
                    model: [
                        { key: "ryogami-paper", label: "Ryogami-paper" },
                        { key: "awww",       label: "awww" }
                    ]
                    FilterButton {
                        colors: root.colors
    ...
    SettingsCard {
        visible: Config.wallpaperEngine === "ryogami-paper"
        colors: root.colors
        title: "Transitions"
